...
export const GET_LAST_THREE_STUDENT_WHO_COMPLETED_ADMISSION_FEE = gql`
  query getLastThreeStudenstAdmissionFee {
    getLastThreeStudenstAdmissionFee {
      id
      matricule
      firstname
      lastname
...
//statistiques total section anglophone
