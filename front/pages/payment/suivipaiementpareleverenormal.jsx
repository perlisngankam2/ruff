                    ...
                    >
                        ...
                        <Box  borderBottom={'1px'} mt={'30px'}>
                            <Heading textAlign={'center'} fontSize={['xl', 'xl', 'xl']} >
                                T3: TABLEAU DE SUIVI  DE PAYEMENT PAR ELEVE :  Régime normal de Paiement
                            </Heading>
                        </Box>
                        <Box ml={'12px'}>
                            ...
                            <TableContainer>
                                <Table size='sm'>
                                    ...
                                    <Tr ml={'100px'}>
                                            ...
                                            <Th textAlign={'center'} colSpan={'3'} borderLeft={'1px'} >Paiement</Th>
                                            <Th textAlign={'center'} colSpan={'2'} borderLeft={'1px'}>Remettant(e)</Th>
                                        </Tr>
                                        <Tr borderTop={'0px'}>
