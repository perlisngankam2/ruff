...
const Bulletin = () => {
  ...
  const { data: dataRetenueMontant } = useQuery(
    GET_ALL_AMOUNT_RETENU_PERSONNEL,
    {
      variables: { personnelid: router.query.id },
    }
  ...
  const dernierElementSalaire =
    dataSalaireId?.getsalairebypersonnel[dernierIndice];
                ...
                >
                  <Box w="1000px">
                    ...
                    <Flex gap="280px" mt="20px">
                      ...
                      <Box w="300px">
                        <Text mt="30px" textAlign={"center"} fontWeight="bold">
                          {dataPersonnelId?.findOnePersonnel.firstName.toUpperCase() +
                            " " +
                            dataPersonnelId?.findOnePersonnel.lastName.toUpperCase()}{" "}
                        </Text>
                        ...
                        <Box mt="20px" w="900px">
                          ...
                          <Flex w="full">
                            <Box w="300px" borderLeft={"1px"} py="6px">
                              ...
                              {dataPrimeNoms &&
                                dataPrimeNoms?.findnamesprimebypersonnel.map(
                                  (prime) => <Text ml="20px">{prime}</Text>
                                )}
                            </Box>
                            <Box w="180px" borderLeft={"1px"} py="6px">
                              {dataPrimeMontant && (
                                <Box mt="20px">
                                  {dataPrimeMontant?.findmontantprimebypersonnel.map(
                                    (prime) => (
                                      <Text textAlign={"right"} mr="6px">
                                        {prime}
                                      </Text>
