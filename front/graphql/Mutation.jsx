...
export const CREATE_CATEGORY_PERSONNEL = gql`
  mutation createcategoriepersonnnel(
    $createCategoriePersonnel: CategoriePersonnelCreateInput!
  ) {
    createcategoriepersonnnel(
      createCategoriePersonnel: $createCategoriePersonnel
    ) {
      id
      nom
      description
...
export const CREATE_CATEGORY_ELEVE = gql`
  mutation createcategorieeleve(
    $createCategorieEleve: CategorieEleveCreateInput!
  ) {
...
export const CREATE_ANNEE_ACADEMIQUE = gql`
  mutation createAnnerAccademique(
...
export const CREATE_REDUCTION_SCOLARITE = gql`
  mutation createreductionscolarite(
    $reductionscolarite: RedutionScolariteInput!
  ) {
...
export const fragmentCycle = gql`
  fragment CycleClass on cyle {
    id
    name
    section
  }
...
export const DELETE_TRANCHE_PENSION = gql`
  mutation deleteTranche($id: String!) {
    deleteTranche(id: $id) {
      id
      name
      description
