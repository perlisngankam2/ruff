...
import { GET_ALL_ATUDENT,   GET_ONE_STUDENT } from "../../graphql/Queries";
...
const DetailComponent = () => {
    ...
    const {data:singleStudent} = useQuery(GET_ONE_STUDENT);
  ...
  <Card bgColor="#CCDEDE" borderWidth={'1.5px'} borderColor='#E2D39C'>
    ...
    <CardBody fontSize={'sm'}>
      ...
      <Text><Text as='b'>Nom : </Text> TINA NFON</Text>
      <Text><Text as='b'>Prenom : </Text> Amos</Text>
      <Text><Text as='b'>Matricule : </Text> GM100488B</Text>
      <Text><Text as='b'>Sexe : </Text> Masculin</Text>
      <Text><Text as='b'>Classe : </Text> CM2</Text>
      <Text><Text as='b'>Section : </Text> ANGLOPHONE</Text>
      <Text mt={5}><Text as='b'>Nom du pere : </Text> Dirac NFON NFON</Text>
      <Text><Text as='b'>Nom de la mere : </Text> Clementine EBEGNE</Text>
      <Text><Text as='b'>Contact du pere : </Text> 654 04 66 38</Text>
      <Text><Text as='b'>Contact de la mere : </Text> 694 29 11 73</Text>
    ...
    <CardFooter>
      <Text>
        <Text as='b'>Année scolaire : </Text>2022 - 2023
      </Text>
    </CardFooter>
  </Card>
